...
def extract_context_for_question(entity_of_interest: str, retrieval_function: str):
    if retrieval_function == "get_threats_for":
        context = idx.get_threats_for(entity_of_interest)
    elif retrieval_function == "get_mitigations_for":
        context = idx.get_mitigations_for(entity_of_interest)
    elif retrieval_function == "get_connected_flows":
        context = idx.get_connected_flows(entity_of_interest)
    elif retrieval_function == "get_trust_boundary_for":
        context = idx.get_trust_boundary_for(entity_of_interest)
    elif retrieval_function == "search":
        context = idx.search(entity_of_interest)
    else:
...
def main():
        ...
        try:
            ...
            for intent in intents:
                ...
                for entity in entities_of_interest:
                    ...
                    context = extract_context_for_question(entity, retrieval_function)
    ...
    file_name = "generated_30_03_owasp_run3.json"
