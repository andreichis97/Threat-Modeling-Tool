        ...
        for entity in entities_of_interest:
            ...
            if ent_type != "BPMN Sub-Process":
                triples = extract_khop_neighborhood(
                    ent_uri, k=1, max_neighbors_per_hop=0
                )
                context_builder = ""
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                #{"role": "system", "content": f"The guiding ontology for the knowledge graph is {ontology}"},
...
def main():
    ...
    file_name = "generated_24_03_1_hops_run5_ontology.json"
